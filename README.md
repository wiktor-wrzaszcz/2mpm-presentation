...
1. 2mpm-landing-site: Landing page project for main page, https://www.2minutespastmidnight.com - written in angular 18.
...
4. 2mtm-web: Angular/Ionic frontend for main application and most of the features, https://app.2minutespastmidnight.com
